          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/launch">
              <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">Lanza tu negocio con todo incluido: SAS, firma y facturación.</p>
                </CardContent>
              </Card>
            </Link>
            <Link href="/cerrar-sas">
              <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">¿Tienes multas? Cierra tu empresa de forma legal y ordenada.</p>
                </CardContent>
              </Card>
            </Link>
